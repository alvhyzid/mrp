          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-slate-600">
                {getFieldLabel('company_id')}: <span className="font-semibold text-slate-900">{companyId === null ? '-' : companyId}</span>
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="inline-flex items-center justify-center rounded-none bg-rose-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-rose-700"
              >
                Keluar
              </button>
              <a href="/dashboard" className="inline-flex items-center justify-center rounded-none border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-900 transition hover:bg-slate-50">
                Dashboard
              </a>
            </div>
          </div>
