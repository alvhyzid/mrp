...
values
(
  v_company_id, 'SEC-04', 'Gerbang Peran untuk /debug dan /test-tenant', 'SEC', 'Keamanan',
...
(
  v_company_id, 'GDG-04', 'Opname Harian oleh Staf Gudang Biasa (Bukan Manager)', 'GDG', 'Gudang',
...
(
  v_company_id, 'PRD-15', 'Tinjau Kategori Gangguan Produksi vs Kondisi Lapangan', 'PRD', 'Produksi',
...
(
  v_company_id, 'PRD-16', 'K8 Belum Bisa Belajar Standar Berbasis Laju (mis. Filling Sachet)', 'PRD', 'Produksi',
...
(
  v_company_id, 'PRD-17', 'Kapasitas Harian Belum Melipatgandakan Berdasarkan Jumlah Shift Aktif', 'PRD', 'Produksi',
...
(
  v_company_id, 'AUD-08', 'Konsistensi Tabel/Daftar: Sorting Kolom & Pola Detail vs Expand-Baris', 'AUD', 'Audit Kualitas',
...
(
  v_company_id, 'KPI-04', 'Snapshot KPI Harian Masih Manual (Belum Ada Scheduler)', 'KPI', 'KPI',
...
(
  v_company_id, 'MRG-07', 'Rata-Rata Tarif Kru Tidak Difilter per Plant/Departemen', 'MRG', 'Margin & Biaya',
...
(
  v_company_id, 'MRG-08', 'Lapis 3 Margin Watch — 7 Tuas Perbaikan', 'MRG', 'Margin & Biaya',
...
(
  v_company_id, 'MRG-09', 'Kelayakan Jadwal: Reframe dari Biner ke Kurva Proyeksi Pengiriman', 'MRG', 'Margin & Biaya',
